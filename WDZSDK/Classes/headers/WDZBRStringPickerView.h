...
typedef void(^WDZBRStringResultBlock)(id selectValue);
typedef void(^WDZBRStringCancelBlock)(void);

@interface WDZBRStringPickerView : WDZBRBaseView
...
+ (void)showStringPickerWithTitle:(NSString *)title
                  ...
                  defaultSelValue:(id)defaultSelValue
                      resultBlock:(WDZBRStringResultBlock)resultBlock;
...
+ (void)showStringPickerWithTitle:(NSString *)title
                  ...
                  defaultSelValue:(id)defaultSelValue
                     isAutoSelect:(BOOL)isAutoSelect
                       themeColor:(UIColor *)themeColor
                      resultBlock:(WDZBRStringResultBlock)resultBlock
                      cancelBlock:(WDZBRStringCancelBlock)cancelBlock;
