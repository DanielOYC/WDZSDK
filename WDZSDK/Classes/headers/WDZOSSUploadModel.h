...
@interface WDZOSSUploadModel : NSObject

/**视频类型:0 图片  1:视频  2:文件*/
@property (nonatomic, assign,readonly) NSInteger contentType;
/**----------------------通过协议创建对象---------------------------*/
@property (nonatomic,strong,readonly) id<WDZOSSUploadAble> uploadModel;

- (instancetype)initWithUploadModel:(id<WDZOSSUploadAble>)uploadModel;
/**------------------------图片对象--------------------------*/
/**上传的图片*/
