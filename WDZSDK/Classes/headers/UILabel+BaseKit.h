...
@interface UILabel (BaseKit)


-(NSMutableAttributedString*)subStr:(NSString *)string andFont:(UIFont *)font;


+(CGFloat)getLabelHeightWithString:(NSString *)str Font:(UIFont *)font andWidth:(CGFloat)width;

+(CGFloat)getLabelHeightWithString:(NSString *)str Font:(UIFont *)font andWidth:(CGFloat)width AtMaxHeight:(CGFloat)maxHeight;
