...
//  test
//
//  Created by dingkan on 2018/10/3.
...
/**
 是否直接获取模型
 YES   代理方法- (void)imagePickerController:(TZImagePickerController *)picker didFinishPickingPhotos:(NSArray<UIImage *> *)photos sourceAssets:(NSArray *)assets isSelectOriginalPhoto:(BOOL)isSelectOriginalPhoto infos:(NSArray<NSDictionary *> *)infos 中 assets 直接获取WDZPickerModel模型对象
 NO    则是原先代理方法
 */
