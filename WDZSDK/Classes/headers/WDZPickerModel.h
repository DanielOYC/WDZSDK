...
//  WDZForAppStore
//
//  Created by dingkan on 2018/9/15.
...
@interface WDZPickerModel : NSObject
...
+(NSMutableArray *)getAssetsWithDatas:(NSMutableArray<WDZPickerModel *> *)datas;
+(NSMutableArray *)getImagesWithDatas:(NSMutableArray<WDZPickerModel *> *)datas;
@end
