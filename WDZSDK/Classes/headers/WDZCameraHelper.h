...
#define kThemeImage(imageName) [WDZCameraHelper image:[UIImage imageNamed:imageName] WithTintColor:kCameraThemeColor]
#define kThemeImageWithImgae(image) [WDZCameraHelper image:image WithTintColor:kCameraThemeColor]
...
@interface WDZCameraHelper : NSObject
// tint只对里面的图案作更改颜色操作
